...
class RemoveFromFavoritesUseCase @Inject constructor(private val repoRepository: RepoRepository) {
    suspend fun execute(repo: Repo) = repoRepository.removeFromFavorites(repo)
}